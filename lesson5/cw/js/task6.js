	// Сколько чашек кофе мы можем сделать?
...
function doCoffee(beansCount) {
	...
	var emoutOfCups = Math.floor(beansCount / 5);
	console.log("Приготовлено чашек кофе:" + emoutOfCups + ", осталось зерен: " + (beansCount - emoutOfCups * 5));
	return;
}